...
.. object:: Gdraw.GlyphListMark... controls the shape of the mark used to show the menu of a combo box.

   .. image:: /images/GlyphListMark.png
...
.. object:: Gdraw.GComboBoxMenu...    Inherits from GComboBox (This is the box drawn around the GlyphListMark in a ComboBox)
...
.. object:: Gdraw.GlyphListMark.Width
...
.. object:: Gdraw.GlyphListMark.Image

   A filename of an image file

   Will be used instead of GlyphListMark.Box if present. This is either a fully
   qualified pathname, or the filename of an image in the pixmap directory.

.. object:: Gdraw.GlyphListMark.DisabledImage

   A filename of an image file

   Will be used instead of GlyphListMark.Box for disabled (non-clickable) instances,
